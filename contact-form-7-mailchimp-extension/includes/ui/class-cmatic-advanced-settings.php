...
class Cmatic_Advanced_Settings {
	...
	public static function render_help_us_improve_row(): void {
		...
		<td>
			...
			<span class="cmatic-toggle-label"><?php esc_html_e( 'Help us improve the plugin.', 'chimpmatic-lite' ); ?></span>
			<a href="https://chimpmatic.com/privacy" class="helping-field" target="_blank" rel="noopener noreferrer"><?php esc_html_e( 'Learn about it', 'chimpmatic-lite' ); ?></a>
			</fieldset>
		</td>
		</tr>
		<?php
